...
- This fits into my career goals because I want to become a DevOps engineer eventually!
...
1. Clone the repository:
    ```bash
    git clone https://github.com/esobrevega/nextwork-web-project.git
    ```
...
Emmanuel Sobrevega - [emtsobrevega@gmail.com](mailto:emtsobrevega@gmail.com)

- [LinkedIn](https://www.linkedin.com/in/esobrevega/)
